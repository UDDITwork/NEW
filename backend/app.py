...
<body>
    ...
    <script>
        ...
        function toggleChat() {
            ...
            if (chatOpen) {
                ...
                fab.innerHTML = '<svg viewBox="0 0 24 24"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2M7.5 13A1.5 1.5 0 0 0 6 14.5a1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5A1.5 1.5 0 0 0 7.5 13m9 0a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5M12 17c-1.5 0-2.81.56-3.84 1.45-.39.34-.16.95.34.95h6.99c.5 0 .74-.61.35-.95A5.98 5.98 0 0 0 12 17z"/></svg>';
            }
        }
    ...
    <button class="chat-fab" id="chat-fab" onclick="toggleChat()" title="Chat with AI Assistant">
        <svg viewBox="0 0 24 24"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2M7.5 13A1.5 1.5 0 0 0 6 14.5a1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5A1.5 1.5 0 0 0 7.5 13m9 0a1.5 1.5 0 0 0-1.5 1.5 1.5 1.5 0 0 0 1.5 1.5 1.5 1.5 0 0 0 1.5-1.5 1.5 1.5 0 0 0-1.5-1.5M12 17c-1.5 0-2.81.56-3.84 1.45-.39.34-.16.95.34.95h6.99c.5 0 .74-.61.35-.95A5.98 5.98 0 0 0 12 17z"/></svg>
    </button>
    ...
    <div class="chat-popup" id="chat-popup">
        <div class="chat-header">
            <div class="chat-header-avatar">
                <svg viewBox="0 0 24 24"><path d="M9.5 4C5.36 4 2 7.36 2 11.5c0 1.54.46 2.97 1.26 4.16L2 20l4.34-1.26c1.19.8 2.62 1.26 4.16 1.26 4.14 0 7.5-3.36 7.5-7.5S13.64 4 9.5 4zm0 13.5c-1.28 0-2.47-.39-3.46-1.06l-.24-.15-2.54.67.67-2.54-.15-.24A5.97 5.97 0 013.5 11.5C3.5 8.19 6.19 5.5 9.5 5.5s6 2.69 6 6-2.69 6-6 6zm6.5-3.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5h2c1.93 0 3.5-1.57 3.5-3.5S19.93 6 18 6h-1.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5H18c2.49 0 4.5 2.01 4.5 4.5s-2.01 4.5-4.5 4.5h-2z"/></svg>
            </div>
