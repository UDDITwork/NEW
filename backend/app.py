...
<body>
    ...
    <script>
        ...
        function toggleChat() {
            ...
            if (chatOpen) {
                ...
                fab.innerHTML = '<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 2.98.97 4.29L2 22l5.71-.97A9.96 9.96 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.4 0-2.74-.36-3.9-.99l-.28-.16-2.89.49.49-2.89-.16-.28A7.96 7.96 0 014 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8zm4.25-5.67c-.23-.12-1.36-.67-1.57-.75-.21-.08-.36-.12-.52.12-.15.23-.6.75-.74.9-.13.16-.27.17-.5.06-.23-.12-.97-.36-1.85-1.14-.68-.61-1.14-1.36-1.28-1.59-.13-.23-.01-.36.1-.47.1-.1.23-.27.35-.4.12-.13.15-.23.23-.38.08-.16.04-.29-.02-.41-.06-.12-.52-1.24-.71-1.7-.19-.45-.38-.39-.52-.39-.13 0-.29-.02-.44-.02s-.4.06-.61.29c-.21.23-.8.78-.8 1.9s.82 2.2.93 2.35c.12.16 1.61 2.46 3.9 3.45.55.24.97.38 1.3.49.55.17 1.05.15 1.44.09.44-.07 1.36-.56 1.55-1.09.19-.54.19-.99.13-1.09-.06-.1-.21-.15-.44-.27z"/></svg>';
            }
        }
    ...
    <button class="chat-fab" id="chat-fab" onclick="toggleChat()" title="Chat with AI Assistant">
        <svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 2.98.97 4.29L2 22l5.71-.97A9.96 9.96 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.4 0-2.74-.36-3.9-.99l-.28-.16-2.89.49.49-2.89-.16-.28A7.96 7.96 0 014 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8zm4.25-5.67c-.23-.12-1.36-.67-1.57-.75-.21-.08-.36-.12-.52.12-.15.23-.6.75-.74.9-.13.16-.27.17-.5.06-.23-.12-.97-.36-1.85-1.14-.68-.61-1.14-1.36-1.28-1.59-.13-.23-.01-.36.1-.47.1-.1.23-.27.35-.4.12-.13.15-.23.23-.38.08-.16.04-.29-.02-.41-.06-.12-.52-1.24-.71-1.7-.19-.45-.38-.39-.52-.39-.13 0-.29-.02-.44-.02s-.4.06-.61.29c-.21.23-.8.78-.8 1.9s.82 2.2.93 2.35c.12.16 1.61 2.46 3.9 3.45.55.24.97.38 1.3.49.55.17 1.05.15 1.44.09.44-.07 1.36-.56 1.55-1.09.19-.54.19-.99.13-1.09-.06-.1-.21-.15-.44-.27z"/></svg>
    </button>
